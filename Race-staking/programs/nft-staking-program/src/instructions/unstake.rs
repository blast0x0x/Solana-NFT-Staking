...
pub struct WithdrawNft<'info> {
    ...
    pub pool_account: Box<Account<'info, PoolConfig>>,
...
pub fn withdraw_nft(ctx: Context<WithdrawNft>) -> Result<()> {
    ...
    let reward_per_day = pool_account.reward_policy_by_class[staking_info.class_id as usize].checked_div(365 as u16).unwrap();
