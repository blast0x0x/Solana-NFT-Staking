...
export interface IBasePoolAsyncThunk extends IBaseAsyncThunk {
  readonly pid: number;
}
...
export interface INFTMintAsyncThunk extends IBaseAsyncThunk {
  readonly amount: number;
  readonly address: string;
}
...
export interface IStakeAsyncThunk extends IBaseAsyncThunk {
  readonly tokenList: number[];
  readonly poolList: number[];
  readonly address: string;
}
